...
impl PairedBitBox {
    ...
    pub fn btc_xpub(
        ...
        match self.query_proto(Request::BtcPub(pb::BtcPubRequest {
            coin: coin as _,
            keypath: keypath.to_vec(),
            display,
    ...
    fn query_proto_btc(
        ...
        match self.query_proto(Request::Btc(pb::BtcRequest {
    ...
    fn get_next_response(&self, request: Request) -> Result<pb::BtcSignNextResponse, Error> {
        match self.query_proto(request)? {
            Response::BtcSignNext(next_response) => Ok(next_response),
            _ => Err(Error::UnexpectedResponse),
        }
    }

    fn get_next_response_nested(
        &self,
        request: pb::btc_request::Request,
    ) -> Result<pb::BtcSignNextResponse, Error> {
        match self.query_proto_btc(request)? {
    ...
    pub fn btc_sign(
        ...
        let mut next_response =
            self.get_next_response(Request::BtcSignInit(pb::BtcSignInitRequest {
                coin: coin as _,
        ...
        loop {
                ...
                .map_err(|_| Error::UnexpectedResponse)?
            {
                pb::btc_sign_next_response::Type::Input => {
                    ...
                    next_response =
                        self.get_next_response(Request::BtcSignInput(pb::BtcSignInputRequest {
                    ...
                    if let Some(host_nonce) = host_nonce {
                        ...
                        {
                            next_response = self.get_next_response_nested(
                ...
                pb::btc_sign_next_response::Type::PrevtxInit => {
                    ...
                    next_response = self.get_next_response_nested(
                        pb::btc_request::Request::PrevtxInit(pb::BtcPrevTxInitRequest {
                ...
                pb::btc_sign_next_response::Type::PrevtxInput => {
                    ...
                    next_response = self.get_next_response_nested(
                        pb::btc_request::Request::PrevtxInput(pb::BtcPrevTxInputRequest {
                ...
                pb::btc_sign_next_response::Type::PrevtxOutput => {
                    ...
                    next_response = self.get_next_response_nested(
                        pb::btc_request::Request::PrevtxOutput(pb::BtcPrevTxOutputRequest {
                ...
                pb::btc_sign_next_response::Type::Output => {
                    ...
                    next_response = self.get_next_response(request)?;
                }
    ...
    pub fn btc_sign_psbt(
        ...
        let our_root_fingerprint = hex::decode(self.root_fingerprint()?).unwrap();
        let (transaction, our_keys) =
            Transaction::from_psbt(&our_root_fingerprint, psbt, force_script_config)?;
        let signatures = self.btc_sign(coin, &transaction, format_unit)?;
    ...
    pub fn btc_sign_message(
        ...
        let response = self.query_proto_btc(pb::btc_request::Request::SignMessage(request))?;
        ...
        let response =
            self.query_proto_btc(pb::btc_request::Request::AntikleptoSignature(request))?;
    ...
    /// policy.
    pub fn btc_is_script_config_registered(
        &self,
        coin: pb::BtcCoin,
        script_config: &pb::BtcScriptConfig,
        keypath_account: Option<&Keypath>,
    ) -> Result<bool, Error> {
        match self.query_proto_btc(pb::btc_request::Request::IsScriptConfigRegistered(
    ...
    /// `keypath_account` must be set if the script config is multisig, and can be `None` if it is a
    /// policy.
    pub fn btc_register_script_config(
        &self,
        coin: pb::BtcCoin,
        script_config: &pb::BtcScriptConfig,
        keypath_account: Option<&Keypath>,
        ...
        match self.query_proto_btc(pb::btc_request::Request::RegisterScriptConfig(
