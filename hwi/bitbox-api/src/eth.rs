...
impl PairedBitBox {
    fn query_proto_eth(
        ...
        match self.query_proto(Request::Eth(pb::EthRequest {
    ...
    pub fn eth_xpub(&self, keypath: &Keypath) -> Result<String, Error> {
        match self.query_proto_eth(pb::eth_request::Request::Pub(pb::EthPubRequest {
...
impl PairedBitBox {
    fn handle_antiklepto(
        ...
        match response {
            pb::eth_response::Response::AntikleptoSignerCommitment(
                ...
                match self.query_proto_eth(pb::eth_request::Request::AntikleptoSignature(
    ...
    pub fn eth_sign_transaction(
        ...
        let response = self.query_proto_eth(request)?;
        self.handle_antiklepto(&response, host_nonce)
    }
    ...
    pub fn eth_sign_message(
        ...
        let response = self.query_proto_eth(request)?;
        let mut signature = self.handle_antiklepto(&response, host_nonce)?;
